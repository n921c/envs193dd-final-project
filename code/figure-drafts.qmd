...
figure1 <- ggplot(data = aq_ins_clean,
  ...
  labs(title = "Relationship Between Water Temperature and Invertebrate Abundance by Species and Site",
...
figure2 <- ggplot(data = aq_ins_clean,
  ...
  labs(x = "Taxon",
       y = "log + 1 transformed average abundance/L",
       title = " Mean and Distribution of Invertebrate Abundance (log +1/L)
       for Three Tax")
...
figure3 <- ggplot(data = aq_ins_clean,
  ...
  labs(title = " Site Patterns Between Water Temperature and Log + 1
       Abundance for Three Dominant Taxa",
       x = "Average Temperature (ºC)",
       y = "log + 1 Transformed Average Abundance/L",
       color = "Site")
...
figure4 <- ggplot(data = aq_ins_clean,
  ...
  facet_wrap(~season,
             scales = "free") +
  labs(title = " Seasonal Patterns Between Water Temperature and Log + 1
       Abundance for Three Dominant Taxa",
       x = "Average Temperature (ºC)",
       y = "log + 1 Transformed Average Abundance/L",
       color = "Taxon") +
