...
Relationship Between Water Temperature and Invertebrate Abundance by Species and Site",
...
Mean and Distribution of Invertebrate Abundance (log +1/L) for Three Taxa")
...
Site Patterns Between Water Temperature and Log + 1 Abundance for Three Dominant Taxa",
       x = "Average Temperature (ºC)",
       y = "log + 1 Transformed Average Abundance/L",
       color = "Site")
...
Seasonal Patterns Between Water Temperature and Log + 1 Abundance
for Three Dominant Taxa",
       x = "Average Temperature (ºC)",
       y = "log + 1 Transformed Average Abundance/L",
       color = "Taxon") +
...
**BELOW PASTE IN THE OTHER EXPLORATORY VISUALS**
